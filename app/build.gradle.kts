...
android {
    namespace = "com.example.raspberrypi"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.raspberrypi"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        create("release") {
            ...
            val storeFile = project.findProperty("SIGNING_STORE_FILE") as String?

            this.keyAlias = keyAlias
            this.keyPassword = keyPassword
            this.storePassword = storePassword
            storeFile?.let {
                this.storeFile = file(it)
            }
        }
    }
